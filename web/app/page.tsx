...
function Glow(props: { style: CSSProperties }) {
  return <div className="glow" style={props.style} aria-hidden />;
}

export default function MarketingHome() {
  return (
    <main className="min-h-screen bg-surface text-ink">
      {/* Hero on the deep-navy brand field, with grid, grain and aurora glows */}
      <section className="relative overflow-hidden brand-field text-white">
        <div className="tex-grid pointer-events-none absolute inset-0" aria-hidden />
        <div className="tex-grain pointer-events-none absolute inset-0 opacity-[0.05] mix-blend-soft-light" aria-hidden />
        <Glow style={{ left: "-6rem", top: "-7rem", height: "26rem", width: "26rem", background: "radial-gradient(circle, rgba(122,192,67,0.45), transparent 62%)" }} />
        <Glow style={{ right: "-5rem", top: "1rem", height: "24rem", width: "24rem", background: "radial-gradient(circle, rgba(74,140,214,0.5), transparent 62%)" }} />
        {/* soft fade into the page surface at the bottom edge */}
        <div className="pointer-events-none absolute inset-x-0 bottom-0 h-24 bg-gradient-to-b from-transparent to-surface/95" aria-hidden />
        ...
        <div className="relative mx-auto max-w-6xl px-5">
          ...
          <div className="max-w-3xl py-16 md:py-24">
            <span className="inline-flex items-center gap-2 rounded-full border border-white/20 bg-white/5 px-3 py-1 text-xs font-medium tracking-wide text-white/85 backdrop-blur">
              <span className="h-1.5 w-1.5 rounded-full accent-gradient" /> Personal CFO for households
            </span>
            ...
            <div className="mt-9 flex flex-wrap items-center gap-3">
              ...
              <Link href="/login" className="rounded-lg border border-white/25 bg-white/5 px-6 py-3 text-sm font-semibold text-white backdrop-blur hover:bg-white/10">Log in</Link>
            </div>
      ...
      {/* Features, over a soft aurora + dotted texture */}
      <section className="relative overflow-hidden">
        <div className="aurora pointer-events-none absolute inset-0" aria-hidden />
        <div className="tex-dots pointer-events-none absolute inset-0 text-ink opacity-[0.04]" aria-hidden />
        <div className="relative mx-auto max-w-6xl px-5 py-16 md:py-24">
          <div className="mx-auto mb-10 max-w-2xl text-center">
            <div className="grad-rule mx-auto mb-6 w-24" />
          ...
          <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-4">
            {FEATURES.map((f) => (
              <div key={f.title} className="group card-premium rounded-2xl border border-line p-5">
                <div className="mb-3 h-1 w-8 rounded-full accent-gradient opacity-80 transition-all group-hover:w-14" />
      ...
      <section className="mx-auto max-w-6xl px-5 pb-4 md:pb-8">
        <div className="relative overflow-hidden rounded-3xl border border-line bg-card p-8 shadow-card md:p-12">
          <Glow style={{ right: "-4rem", bottom: "-5rem", height: "20rem", width: "20rem", background: "radial-gradient(circle, rgba(31,157,85,0.28), transparent 65%)" }} />
          <Glow style={{ left: "-5rem", top: "-6rem", height: "18rem", width: "18rem", background: "radial-gradient(circle, rgba(30,58,95,0.20), transparent 66%)" }} />
      ...
      <section className="mx-auto max-w-6xl px-5 py-16">
        <div className="brand-field relative flex flex-col items-start justify-between gap-5 overflow-hidden rounded-3xl px-8 py-12 text-white shadow-lift md:flex-row md:items-center md:px-12">
          <div className="tex-grid pointer-events-none absolute inset-0" aria-hidden />
          <Glow style={{ right: "-3rem", top: "-4rem", height: "18rem", width: "18rem", background: "radial-gradient(circle, rgba(122,192,67,0.4), transparent 62%)" }} />
          <div className="relative">
          ...
          <Link href="/register" className="accent-gradient relative shrink-0 rounded-lg px-6 py-3 text-sm font-semibold text-white shadow-lift hover:opacity-95">Get started free</Link>
        </div>
      </section>
